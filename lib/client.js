...
function getRules(){
    return '{"request": {"101":{"source":"$req.headers.origin","target":"$req.headers.host","type":"EQUAL","rule":"","description":"CSRF attack","tag":"csrf","score":"30"},"102":{"source":"$req.headers.origin","target":"$req.headers.host","type":"COMPARE","rule":"!=","description":"CSRF attack","tag":"csrf","score":"30"}}}'  
}
