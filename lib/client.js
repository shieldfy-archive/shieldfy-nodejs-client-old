...
Client.prototype.start = function(opts)
{
    ...
    this._jury = new Jury(getRules(),this);
...
function getRules(){
    return '{"request": {        "101":{            "source":"$req.headers.origin",     "target":"$req.headers.host",        "type":"COMPARE",            "rule":"!=",            "description":"CSRF attack",            "tag":"csrf",            "score":"30"      }    } }'  
}
