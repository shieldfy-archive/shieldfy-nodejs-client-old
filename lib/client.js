...
function getRules(){
    return JSON.parse('{ "request":{ "101":{"source":"$req.headers.origin","target":"$req.headers.host","type":"CONTAIN","rule":"<script>|</script>","description":"CSRF attack","tag":"csrf","score":"3000"}}}');  
}
