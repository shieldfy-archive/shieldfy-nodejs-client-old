...
Session.prototype._proxy = function(Client,exports,module, version){
            ...
            if (event === 'request') {
                ...
                //     // console.log("FINISHED")
                    try {
                        ...
                        new requestCollector(Client._currentRequest._$req, res, function(data){
    ...
    shimmer.massWrap(exports && exports.ServerResponse && exports.ServerResponse.prototype, ['write'], function (original) {
        return function () {
            // console.log('# write monitor # AsyncID '+asyncHooks.executionAsyncId()+' triggerId '+asyncHooks.triggerAsyncId())
            try {
                ...
                if(Client._currentRequest.isDanger()){
                    ...
                    try {
                        ...
                        Client._currentResponse.setHeader('Transfer-Encoding','chunked');
