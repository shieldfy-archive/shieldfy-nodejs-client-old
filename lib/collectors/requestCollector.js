 ...
 * @param {function} cb 
 */
RequestCollector.prototype.collectData=function (req,cb)
{
...
RequestCollector.prototype.getProtocol=function (req)
{
    ...
    //       single value, but req is to be safe.
